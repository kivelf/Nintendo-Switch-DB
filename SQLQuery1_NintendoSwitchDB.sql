...
-- only the first 15 inserts are shown for brevity's sake - keep in mind the complete table contains 500 entries
...
-- only the first 15 inserts are shown for brevity's sake - keep in mind the complete table contains ~4000 entries
